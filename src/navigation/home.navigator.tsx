...
import { MainScreenNavigator } from "./mainScreen.navigator";
 ...
 */
const initialTabRoute: string = __DEV__ ? "Dashboard" : "MainScreen";

const ROOT_ROUTES: string[] = ["Home", "MainScreen", "Dashboard", "Themes"];
...
const HomeTabsNavigator = (): React.ReactElement => (
  ...
  >
    <BottomTab.Screen name="MainScreen" component={MainScreenNavigator} />
    <BottomTab.Screen name="Dashboard" component={ComponentsNavigator} />
